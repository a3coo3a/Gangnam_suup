...
//		for (User arr : userArr) {
//			System.out.println("이름 : "+ arr.getName());
//			System.out.println("주민번호 : "+ arr.getRrn());
//			System.out.println("나이 : "+ arr.getAge());
//		}
		for (int i = 0; i < userArr.length; i++) {
			System.out.println("이름 : " + userArr[i].getName());
			System.out.println("번호 : " + userArr[i].getRrn());
			System.out.println("나이 : " + userArr[i].getAge());
		}
		 ...
		 */
		User[] userArr1 = new User[5];
		Scanner sc = new Scanner(System.in);
		
		int i = 0;
		while(i < userArr1.length) {
			User user2 = new User();
			System.out.print("이름 : ");
			user2.setName(sc.next());
			System.out.print("주민번호 : ");
			user2.setRrn(sc.nextInt());
			System.out.print("나이 : ");
			user2.setAge(sc.nextInt());
			
			userArr1[i] = user2;
			
			System.out.println(Arrays.toString(userArr1));
			i++;
		}
